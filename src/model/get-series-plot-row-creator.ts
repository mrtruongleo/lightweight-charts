...
function getCustomSeriesPlotRow<HorzScaleItem>(
	...
	const {
		...
		color,
		...data
	} = item as CustomData<HorzScaleItem>;
...
function wrapCustomValues<
	T extends SeriesPlotRow | WhitespacePlotRow,
	HorzScaleItem
>(
	plotRow: Mutable<T>,
...
export function getSeriesPlotRowCreator<
	TSeriesType extends SeriesType,
	HorzScaleItem
>(seriesType: TSeriesType): SeriesItemValueFnMap<HorzScaleItem>[TSeriesType] {
